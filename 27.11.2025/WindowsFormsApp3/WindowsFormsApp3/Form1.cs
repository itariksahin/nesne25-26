...
namespace WindowsFormsApp3
{
    public partial class Form1 : Form
    {
        ...
        {
            ortalamabul top=new ortalamabul();
            MessageBox.Show(top.topla(Convert.ToInt16(textBox1.Text),
            ...
            Convert.ToInt16(textBox15.Text)).ToString());
        }
    }
}
